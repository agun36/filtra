...
export const Contacts = () => {
    ...
    return (
        <section className="contacts bg-bg-100 d-flex flex-column justify-content-center align-items-center modal-dialog modal-dialog-centered">
            <div className="modal-content d-flex align-items-center flex-column">
                <h1 className="text-white col mb-5 text-center">Ready to simplify your workflow? Get started with Filetra today.</h1>
